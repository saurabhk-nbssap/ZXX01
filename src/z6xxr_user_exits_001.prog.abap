...
*&---------------------------------------------------------------------*
*----------------------------------------------------------------------*
* OBJECT DESCRIPTION: List of Enhancements
*.
*          DEVELOPER: Ramakrishna
*      CREATION DATE: 09.06.2010
*        DEV REQUEST: IRDK900056
*----------------------------------------------------------------------*
...
*--------------------------------------------------------------------*
  PARAMETERS: p_pname LIKE trdir-name,
*}   REPLACE
...
*{   REPLACE        SBXK900030                                        2
*\parameter: p_badi  as checkbox default c_x,
PARAMETERS: p_badi  AS CHECKBOX DEFAULT c_x,
*}   REPLACE
...
selection-screen skip.
*{   REPLACE        SBXK900030                                        5
*\parameter: p_devc  like rihea-dy_ofn default ' ' modif id a01,
PARAMETERS: p_devc LIKE rihea-dy_ofn DEFAULT ' ' MODIF ID a01,
*}   REPLACE
