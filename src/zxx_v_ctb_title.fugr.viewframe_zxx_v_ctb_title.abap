*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZXX_V_CTB_TITLE
*   generation date: 10.11.2020 at 09:43:04
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZXX_V_CTB_TITLE     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZXX_V_CTB_TITLE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZXX_V_CTB_TITLE_EXTRACT
TOTAL = ZXX_V_CTB_TITLE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZXX_V_CTB_TITLE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZXX_V_CTB_TITLE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZXX_V_CTB_TITLE_EXTRACT
TOTAL = ZXX_V_CTB_TITLE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZXX_V_CTB_TITLE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZXX_V_CTB_TITLE'
...
TOTAL = ZXX_V_CTB_TITLE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZXX_V_CTB_TITLE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZXX_V_CTB_TITLE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZXX_V_CTB_TITLE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZXX_V_CTB_TITLE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZXX_V_CTB_TITLE_EXTRACT
TOTAL = ZXX_V_CTB_TITLE_TOTAL
